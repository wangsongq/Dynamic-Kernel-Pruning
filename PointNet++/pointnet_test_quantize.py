...
quantized_weights_dict = torch.load('/home/yue/cimcam/quantize_0112/quantized_weights_epoch_1.pth')
for name, param in quantized_weights_dict.items():
    # print(name)
    # print(param.shape)
    if 'weight' in name and 'Conv' and 'pt_sa1' in name:
        print(name)
...
# os.makedirs("./quantize_0112", exist_ok=True)
...
#     # 创建一个空字典来保存当前epoch的量化后的权重与名称
#     quantized_weights_dict = {}
#     # saved_model = torch.load('/home/yue/cimcam/weights_epoch_{i}_after_pruning.pth')  # 加载整个模型对象
#     model.load_state_dict(torch.load(f'/home/yue/cimcam/weights_epoch_{i}_after_pruning.pth'))

#     for name, param in model.named_parameters():
#         # print(name)
#         # print(param.shape)
#         if 'weight' in name and 'Conv' in name:
#             new_param = Quantize.apply(param)
#             # print(new_param)
#             quantized_weights_dict[name] = new_param
#     # 保存量化后的模型权重到新文件中
#     torch.save(quantized_weights_dict, f'/home/yue/cimcam/quantize_0112/quantized_weights_epoch_{i}.pth')
